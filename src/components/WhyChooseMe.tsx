          ...
          {valueProps.map((item, index) => {
            ...
            return (
              <article
                ...
                className="rounded-2xl border border-white/10 bg-eerie p-6 opacity-0 translate-y-6 transition-[opacity,transform,border-color] duration-500 ease-out will-change-transform hover:border-gold/40 [&.is-visible]:translate-y-0 [&.is-visible]:opacity-100"
              >

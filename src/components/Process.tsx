        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2 lg:grid-cols-6">
          {steps.map((step, index) => (
            <div
              ...
              className="relative rounded-2xl border border-black/10 bg-eerie p-5 text-center opacity-0 translate-y-6 transition-[opacity,transform,border-color] duration-500 ease-out will-change-transform [&.is-visible]:translate-y-0 [&.is-visible]:opacity-100"
            >
              {index < steps.length - 1 && (
                <div className="absolute -right-6 top-1/2 hidden h-[5px] w-6 bg-eerie lg:block" />
              )}
